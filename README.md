...
**A2C vs Baseline (^DJI)**
![A2C vs Baseline](results/a2c_vs_baseline.png)

**DDPG vs Baseline (^DJI)**
![DDPG vs Baseline](results/ddpg_vs_baseline.png)

**A2C vs DDPG**
![A2C vs DDPG](results/a2c_vs_ddpg.png)

**Full Dashboard**
![Performance Dashboard](results/all_combined_dashboard.png)
